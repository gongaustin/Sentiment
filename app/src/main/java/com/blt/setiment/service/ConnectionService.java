package com.blt.setiment.service;
...
import com.blt.setiment.common.db.DbHelper;
...
import com.blt.setiment.common.rxbus.event.HandleEvent;
import com.blt.setiment.common.utils.LogUtil;
import com.blt.setiment.founction.user.bean.UserBean;
...
//                RxBus.getInstance().post(new FriendListenerEvent(packet.getFrom(),"","MainActivity"));
